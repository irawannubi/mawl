...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('list_type')); ?>:</b>
	<?php echo CHtml::encode($data->list_type); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('sub_product_id')); ?>:</b>
	<?php echo CHtml::encode($data->sub_product_id); ?>
	<br />
